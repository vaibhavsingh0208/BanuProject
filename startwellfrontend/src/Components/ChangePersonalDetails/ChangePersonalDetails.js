...
class Subscriptions extends React.Component {
  ...
  componentDidMount() {
    ...
    axios
      .get('http://localhost:9000/profiledetails', {
        headers: {
          token: usid
        }
      })
  ...
  handleSubmit = e => {
    axios
      .put('http://localhost:9000/profileupdate', {
        headers: {
                  ...
                  <Card className='cardMain' hoverable>
                    ...
                    <Row>
                      ...
                      <Col style={{ textAlign: 'left' }} span={9}>
                        ...
                        <DatePicker
                          ...
                          placeholder={moment({ DOB }, 'YYYY-MM-DD')}
                          format='YYYY-MM-DD'
                        ></DatePicker>
                        <br></br>
                        <br></br>
                        ...
                        <Input
                          ...
                          placeholder={this.state.LicenseID}
                          className='vals'
                        ></Input>
                        <Link className='changeSub' to='/Subscriptions'>
                          {this.state.disab}
                        </Link>
                      </Col>
                      <Col span={2}></Col>
                    ...
                    <Row>
                      <Col span={24} style={{ textAlign: 'center' }}>
                        ...
                        <br></br>
                        <br></br>
                        <Button className='saveChanges' onClick={this.handleSubmit}>
                          SAVE CHANGES
                        </Button>
                        <br></br>
                        <br></br>
